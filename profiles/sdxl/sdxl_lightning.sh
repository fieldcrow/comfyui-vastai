#!/bin/bash
# DESC: SDXL Lightning — DreamShaper XL Lightning, 3-6 steps
#
# ComfyUI Provisioning Script — Lane 3: Lightning
# Generated from Prompting Pixels, corrected filenames and paths
#
# Settings: CFG 2, 3-6 steps, DPM++ SDE Karras
# No DMD2 LoRA — Lightning is natively fast
#
...
CHECKPOINT_MODELS=(
    "https://civitai.com/api/download/models/354657|dreamshaperXL_lightning_dpm_sde.safetensors"
)
...
echo ""
echo "=============================================="
echo "  Lane 3: DreamShaper XL Lightning"
echo "  CFG 2 | 3-6 steps | DPM++ SDE Karras"
echo "=============================================="
echo ""
...
echo ""
echo "=============================================="
echo "  Lane 3 complete! Lightning ready."
echo "=============================================="
