#!/bin/bash
# DESC: SDXL v2.1 Turbo — DreamShaper XL v2.1 Turbo, fast at 4-8 steps natively
#
# ComfyUI Provisioning Script — Lane 1: v2.1 Turbo
# Generated from Prompting Pixels, corrected filenames and paths
#
# Settings: CFG 2, 4-8 steps, DPM++ SDE Karras
# No DMD2 LoRA needed — Turbo is natively fast
#
...
echo ""
echo "=============================================="
echo "  Lane 1: DreamShaper XL v2.1 Turbo"
echo "  CFG 2 | 4-8 steps | DPM++ SDE Karras"
echo "=============================================="
echo ""
...
echo ""
echo "=============================================="
echo "  Lane 1 complete! v2.1 Turbo ready."
echo "=============================================="
